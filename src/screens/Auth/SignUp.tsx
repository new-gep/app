    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.card }}>
      ...
      {!waitProcess ? (
        <ScrollView style={{ flex: 1 }}>
          <View
            style={{ marginTop: "60%" }}
            className={`items-center justify-center w-full text-center gap-2`}
          >
            ...
            <View style={{}}>
              <View style={{ marginBottom: 30 }}>
                ...
                <Text style={[styles.title2, { color: colors.title }]}>
                  Crie uma conta de maneira ágil e segura. Gerencie informações
                  e processos de forma eficiente, com total transparência e
                  controle.
                </Text>
              </View>
              ...
              <View style={{ marginBottom: 20, marginTop: 10 }}>
                <Input
                  ...
                  onChangeText={(masked, unmasked) =>
                    setFormValues({ ...formValues, cpf: unmasked })
                  }
              ...
              <View style={{ marginBottom: 20, marginTop: 10 }}>
                <Input
                  ...
                  onChangeText={(masked, unmasked) =>
                    setFormValues({ ...formValues, phone: unmasked })
                  }
