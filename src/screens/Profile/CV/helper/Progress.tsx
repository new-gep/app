                ...
                <View className="flex-1">
                  ...
                  <View className="flex-row mt-2 justify-between">
                    ...
                    <View className="flex-row items-center mt-2 ml-4">
                      <Text style={{fontSize:rf(14)}} className="text-black ">Cursando</Text>
                      <Switch
                        style={{
          ...
          <View className="flex-col gap-3">
            {savedEducation.map((edu: any, index: any) => (
              <View key={index} className="bg-white rounded-lg">
                <View className="flex-row">
                  <Text style={{fontSize:rf(17)}} className="text-black font-bold">Curso: </Text>
                  <Text style={{fontSize:rf(16)}}>{edu.degree}</Text>
                </View>
                <View className="flex-row">
                  <Text style={{fontSize:rf(17)}} className="text-black font-bold">Instituição: </Text>
                  <Text style={{fontSize:rf(16)}}>{edu.institution}</Text>
                </View>
                <View className="flex-row">
                  <Text style={{fontSize:rf(17)}} className="text-black font-bold">Período: </Text>
